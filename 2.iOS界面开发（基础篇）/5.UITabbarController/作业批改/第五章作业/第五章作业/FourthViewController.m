...
- (void)viewDidLoad {
    ...
    UIImage *normalImage = [[UIImage imageNamed:@"购物车normal"] imageWithRenderingMode: UIImageRenderingModeAlwaysOriginal];
    UIImage *selectedImage = [[UIImage imageNamed:@"购物车hover"] imageWithRenderingMode: UIImageRenderingModeAlwaysOriginal];
    
    self.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"购物车" image:normalImage selectedImage:selectedImage];
