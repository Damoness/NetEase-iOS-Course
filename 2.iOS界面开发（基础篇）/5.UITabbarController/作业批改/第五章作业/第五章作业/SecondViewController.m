...
- (void)viewDidLoad {
    ...
    UIImage *normalImage = [[UIImage imageNamed:@"活动normal"] imageWithRenderingMode: UIImageRenderingModeAlwaysOriginal];
    UIImage *selectedImage = [[UIImage imageNamed:@"活动hover"] imageWithRenderingMode: UIImageRenderingModeAlwaysOriginal];
    
    self.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"活动" image:normalImage selectedImage:selectedImage];
