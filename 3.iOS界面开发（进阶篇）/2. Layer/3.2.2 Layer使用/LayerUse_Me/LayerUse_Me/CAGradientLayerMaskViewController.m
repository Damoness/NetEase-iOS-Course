//
//  CAGradientLayerMaskViewController.m
//  LayerUse_Me
//
...
#import "CAGradientLayerMaskViewController.h"

@interface CAGradientLayerMaskViewController ()

@end

@implementation CAGradientLayerMaskViewController
...
- (void)viewDidLoad {
    ...
    mirrorImageView.center = CGPointMake(imageView.center.x,  CGRectGetHeight(imageView.frame) + CGRectGetMidY(imageView.frame));
