...
- (void)viewDidLoad
{
    ...
    AudioObject *avAudioPlayer = [AudioObject new];
    avAudioPlayer.title = @"AVAudioPlayer";
    avAudioPlayer.className = @"AVAudioPlayerViewController";

    AudioObject *output = [AudioObject new];
    output.title = @"OutputDevice";
    output.className = @"OutputDeviceViewController";
    
    _data = @[avAudioPlayer,output];
}
